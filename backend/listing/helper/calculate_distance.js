...
const calculateDistance = (user_id, listing_id, user_location, listing_location) => {
...
const result = listings.map(listing => calculateDistance(user_id, listing.listing_id, user_location, listing.listing_location)).filter(listing => listing !== null);
